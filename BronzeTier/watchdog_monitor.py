"""
watchdog_monitor.py – System Watchdog (Bronze → Platinum)
...
Error Category: SYSTEM (Orchestrator crash, disk full) → auto-restart
"""
...
def check_disk_space() -> float:
    ...
    try:
        ...
        return 999.0  # Can't check — don't block
...
class WatchdogMonitor:
    ...
    def run(self):
        ...
        while True:
            ...
            # ── Wait before restart (exponential backoff up to 5 min) ───────
